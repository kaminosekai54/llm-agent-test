...
def pubMedArticleSearch(keywords: str, start_date : str, end_date : str ) -> str:
    """
    ...
    start_date and end_date should be given in the dd/mm/yyyy format.
    ...
    try:
        ...
        # start_date = (datetime.now() - pd.DateOffset(years=5)).strftime("%d/%m/%Y")
